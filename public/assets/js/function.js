...
(function ($) {
    ...
    function initSwipers() {
        ...
        if (heroSliderEl) {
            ...
            new Swiper(heroSliderEl, {
                ...
                speed: 1000,
                spaceBetween: 0,
                loop: slideCount > 1, // ✅ only loop if enough slides
                autoplay: { delay: 4000 },
        ...
        if (testimonialEl) {
            const slideCount = testimonialEl.querySelectorAll('.swiper-slide').length;
        ...
        /* Service Single Image Carousel JS */
        const serviceSliderEl = document.querySelector('.service-single-slider .swiper');
        if (serviceSliderEl) {
            const slideCount = serviceSliderEl.querySelectorAll('.swiper-slide').length;
            new Swiper(serviceSliderEl, {
                slidesPerView: 1,
                speed: 1000,
                spaceBetween: 10,
                loop: slideCount > 1, // ✅
    ...
    /* Re-initialize on Livewire updates (optional) */
