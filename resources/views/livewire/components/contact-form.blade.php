<div>
    <div class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-extrabold text-primary mb-6 text-center">{{$homepage->contact_title}}</h2>
            <p class="text-xl text-center text-gray-600 mb-12">
                {{$homepage->contact_paragraph}}
            </p>
            ...
            <form wire:submit.prevent="submit" class="space-y-6">
                ...
                <div class="text-center">
                    <button
                        type="submit"
                        class="inline-block bg-primary hover:bg-opacity-90 text-white font-bold text-lg py-3 px-10 rounded-full shadow-xl transition duration-300 transform hover:scale-105 border-2 border-primary"
